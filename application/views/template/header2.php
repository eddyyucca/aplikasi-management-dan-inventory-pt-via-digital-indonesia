    ...
    <div id="wrapper">
      ...
      <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('home') ?>">
          ...
          <div class="sidebar-brand-text mx-3">PT. VIA</div>
        </a>
        <!-- Divider -->
        ...
        <li class="nav-item">
          <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
            ...
            <span>Departemen Dan Akun</span>
          </a>
          <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <a class="collapse-item" href="<?= base_url('departemen') ?>">Departemen</a>
        ...
        <?php } elseif ($level_akun == "super_admin") { ?>
          <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages" aria-expanded="true" aria-controls="collapsePages">
              <i class="fas fa-fw fa-folder"></i>
              <span>Order</span>
            ...
            <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="<?= base_url('super_admin/order_persetujuan') ?>">Order Persetujuan</a>
                <a class="collapse-item" href="<?= base_url('order') ?>">Order Tunggu</a>
                <a class="collapse-item" href="<?= base_url('order/order_selesai') ?>">Order Selesai</a>
              </div>
            </div>
                ...
                <?php } elseif ($level_akun == "super_admin") { ?>
                  ...
                  <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                    ...
                    foreach ($alerts_3 as $x) :
                      if ($no++ > 4) break;
                    ?>
                      <a class="dropdown-item d-flex align-items-center" href="<?= base_url('super_admin/view/') . $x->id_ker ?>">
                        <div class="mr-3">
                          <div class="icon-circle bg-primary">
                            <i class="fas fa-file-alt text-white"></i>
                          </div>
