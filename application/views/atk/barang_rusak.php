            ...
            <div class="row">
                <div class="container-fluid">
                    ...
                    if ($data == false) {
                        ...
                        <form action="<?= base_url('atk/update_barang_rusak/') . $data->id;  ?>" method="POST">
                            ...
                            <div class=" form-group">
                                <label for="inputItem">Item</label>
                                <input class="form-control" name="jumlah" step="1" data-step-max="10" type="number" id="inputLoop" value="1" data-decimals="0" min="1" max="<?= $data->qty; ?>">
                            </div>
