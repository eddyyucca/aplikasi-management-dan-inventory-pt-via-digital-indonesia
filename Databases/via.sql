...
--
-- Host: localhost:8889
-- Generation Time: Feb 22, 2023 at 12:01 AM
...
INSERT INTO `data_barang` (`id`, `item`, `qty`, `satuan`, `kondisi`, `status_barang`) VALUES
(1, 'Amplop Coklat C3', '38', 'Pack', 'ok', 'ok'),
(2, 'Amplop Coklat D (folio) Samson', '12', 'Pack', '', ''),
(3, 'Amplop jaya 95x152mm', '12', 'Pack', '', ''),
(4, 'Amplop Surat Putih (110 x 230 mm)', '7', 'Pack', '', ''),
(5, 'Ball Point Snowman V5 Hitam', '46', 'Pcs', '', ''),
...
--
-- Dumping data for table `data_catering`
--
...
('1202005082', 'eddy adha saputra', 'eddy', 'Laki-Laki', 'tapin', '2020-05-08', 'Tapin\r\n', '', '', '', '', '', 0, '', '', 0, '', '', 0, '', '', 0, 0, 0, 0, '', '', '112', '', '', '', '', '', '', '', 1, 1, '', 'Ya', 'foto.jpg'),
('1202005083', 'eddy adha saputra', 'eddy', 'Laki-Laki', 'tapin', '2020-05-08', 'Tapin\r\n', '', '', '', '', '', 0, '', '', 0, '', '', 0, '', '', 0, 0, 0, 0, '', '', '112', '', '', '', '', '', '', '', 1, 1, '', 'Ya', 'foto.jpg');

-- --------------------------------------------------------

--
-- Table structure for table `data_mess_lahan`
--
...
--
-- Dumping data for table `data_mess_lahan`
--
...
(69, '15', '1', '1', 'Syamsul Suriadi', '1', '2023-01-03', ''),
(70, '16', '1', '1', 'Syamsul Suriadi', '1', '2023-01-03', ''),
(71, '17', '1', '1', 'Syamsul Suriadi', '1', '2023-01-03', ''),
(72, '18', '1', '1', 'Syamsul Suriadi', '1', '2023-01-03', ''),
(73, '19', '1', '1', 'Syamsul Suriadi', '1', '2023-01-03', ''),
(74, '20', '1', '1', 'Syamsul Suriadi', '1', '2023-01-03', ''),
(75, '21', '1', '1', 'Syamsul Suriadi', '1', '2023-01-03', ''),
(76, '22', '1', '1', 'Syamsul Suriadi', '1', '2023-01-03', ''),
(77, '23', '1', '1', 'Syamsul Suriadi', '1', '2023-01-03', ''),
(78, '24', '1', '1', 'Syamsul Suriadi', '1', '2023-01-03', ''),
(79, '25', '1', '1', 'Syamsul Suriadi', '2', '2023-01-04', ''),
(80, '26', '1', '1', 'Syamsul Suriadi', '2', '2023-01-04', ''),
(81, '27', '1', '1', 'Syamsul Suriadi', '2', '2023-01-04', ''),
(82, '27', '1', '1', '', '2', '2023-01-04', '');
...
(27, '1', 'Syamsul Suriadi', 1, '2023-01-04');
...
INSERT INTO `user` (`id`, `nama_user`, `password`, `id_dep`, `id_jab`, `level`) VALUES
(16, 'pa eko', '202cb962ac59075b964b07152d234b70', '1', '2', 'admin'),
(18, 'eddy', '202cb962ac59075b964b07152d234b70', '8', '3', 'user'),
(26, 'Pa ansari', 'caf1a3dfb505ffed0d024130f58c5cfa', '1', '4', 'super_admin'),
(27, 'biasa', '202cb962ac59075b964b07152d234b70', '11', '5', 'user'),
(29, 'eddy adha saputra', '0d35fe1507bad23cd0d523f09c7f18ba', '1', '15', 'user');
...
(33, '1199503122', '87ec84afcf37894d64f22eb521a6234b', 'kepala_gs'),
(36, '1202005081', '87ec84afcf37894d64f22eb521a6234b', 'user'),
(37, '1202005082', '87ec84afcf37894d64f22eb521a6234b', 'hr_admin'),
(38, '1202005083', '87ec84afcf37894d64f22eb521a6234b', 'admin_dep');
...
--
-- Indexes for table `data_catering`
--
...
--
-- Indexes for table `data_mess_lahan`
--
...
--
-- AUTO_INCREMENT for table `data_catering`
--
ALTER TABLE `data_catering`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `data_mess_lahan`
--
ALTER TABLE `data_mess_lahan`
...
--
ALTER TABLE `data_order`
  MODIFY `id_order` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;
...
--
ALTER TABLE `jabatan`
  MODIFY `id_jab` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `order_status`
--
ALTER TABLE `order_status`
  MODIFY `id_ker` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `user_login`
  MODIFY `id_userlog` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
COMMIT;
